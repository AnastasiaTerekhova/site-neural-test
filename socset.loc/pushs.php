<div class="user-card-all">
    ...
    <h1 style="font-size: 20px; 
        ...
        color:#032133e8;">Список уведомлений:</h1><br>
    <?php
    ...
    if (isset($_POST['tofriend'])) {
        if (isset($_POST['add'])) {
            ...
            $infoo1 = json_decode($user['info_json']);
            if ($info1 = null) $infoo1 = array();
            array_push($infoo1->friends, $push['fromuser']);
            $json = json_encode($infoo1, JSON_UNESCAPED_UNICODE);
